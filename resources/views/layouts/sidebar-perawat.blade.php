...
<div class="sidebar">
    ...
    <!-- PROFILE CARD (PERAWAT VERSION) -->
    <div class="profile-card">
        <div class="profile-top">
            <div class="profile-avatar">💉</div>
            <div class="profile-info">
                <h4>{{ Auth::user()->name ?? 'Perawat User' }}</h4>
                <p>Perawat IGD</p>
            </div>
        </div>
        <div class="profile-status">
            <span class="status-dot"></span>
            <span>Perawat Active</span>
        </div>
    </div>
...
.sidebar{
    ...
    background:linear-gradient(180deg, #a8c7ff 0%, #cfe3ff 40%, #e6f1ff 75%, #f5f9ff 100%);
    position:fixed;
    top:0;
    left:0;
    overflow-y:auto;
